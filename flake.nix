{
  description = "ClearVoice - A fork of Handy focused on atypical speech transcription using fine-tuned Parakeet models";
  ...
  outputs =
    ...
    in
    {
      packages = forAllSystems (
        ...
        in
        {
          clearvoice = pkgs.rustPlatform.buildRustPackage {
            pname = "clearvoice";
            inherit version;
            src = self;
            ...
            meta = {
              description = "ClearVoice - A fork of Handy focused on atypical speech transcription";
              homepage = "https://github.com/Kasuletrevor/clearvoice";
              license = lib.licenses.mit;
              mainProgram = "clearvoice";
              platforms = supportedSystems;
            };
          };

          default = self.packages.${system}.clearvoice;
        }
      );
      ...
      nixosModules.default =
        { lib, pkgs, ... }:
        {
          ...
          programs.clearvoice.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.clearvoice;
        };
      ...
      homeManagerModules.default =
        { lib, pkgs, ... }:
        {
          ...
          services.clearvoice.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.clearvoice;
        };
      ...
      devShells = forAllSystems (
        ...
        in
        {
          default = pkgs.mkShell {
            ...
            shellHook = ''
              echo "ClearVoice development environment"
              bun install
